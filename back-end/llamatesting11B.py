...
def remove_text_with_llama_vision(image_path, new_text):
        ...
        "messages": [
            {
                "role": "user",
                "content": [
                    {"type": "text", "text": f"Replace text in this image with '{new_text}'"},
    ...
    if response.status_code == 200:
        ...
        output_image_url = output_data["output"]["image_url"]
        return output_image_url  # URL of the processed image
    else:
